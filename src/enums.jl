...
@static if VERSION < v"0.7-"
    ...
    @enum OraPoolGetMode::UInt32 ORA_MODE_POOL_GET_WAIT=0 ORA_MODE_POOL_GET_NOWAIT=1 ORA_MODE_POOL_GET_FORCEGET=2 ORA_MODE_POOL_GET_TIMEDWAIT=3
    ...
    """
    @enum OraPoolGetMode::UInt32 begin
