...
let
    ...
    @time pool = Oracle.Pool(ctx, username, password, connect_string, max_sessions=NUM_CONNECTIONS)

    println("Time to acquire $NUM_CONNECTIONS connections from the pool")
